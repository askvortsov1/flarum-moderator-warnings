  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_utils_PostControls__WEBPACK_IMPORTED_MODULE_2___default.a, "moderationControls", function (items, post) {
    ...
    items.add("warning", m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a, {
      ...
      onclick: function onclick() {
        return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(_components_WarningModal__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  app.routes["user.warnings"] = {
    ...
    component: _components_WarningPage__WEBPACK_IMPORTED_MODULE_3__["default"]
  };
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_UserPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, "navItems", function (items) {
    if (app.session.user && (app.session.user.canViewWarnings() || this.user.id() === app.session.user.id() && this.user.visibleWarningCount() > 0)) {
      items.add("warnings", flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_2___default.a.component({
        ...
        icon: "fas fa-exclamation-circle"
      }, [app.translator.trans("askvortsov-moderator-warnings.forum.user.warnings"), this.user.visibleWarningCount() > 0 ? m("span", {
...
var PostWarningList = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, this.attrs.post.warnings().map(function (warning) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  destructiveControls: function destructiveControls(warning, context) {
    ...
    if (!warning.isHidden() && app.session.user.canManageWarnings()) {
      items.add("hide", m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_0___default.a, {
    ...
    if (warning.isHidden() && app.session.user.canManageWarnings()) {
      items.add("restore", m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_0___default.a, {
        icon: "fas fa-reply",
    ...
    if (warning.isHidden() && app.session.user.canDeleteWarnings()) {
      items.add("delete", m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_0___default.a, {
        icon: "fas fa-times",
...
var WarningList = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }), !this.loading && this.warnings.length === 0 && m("label", null, flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.translator.trans("askvortsov-moderator-warnings.forum.warning_list.no_warnings"))), m("div", {
  ...
  _proto.actionItems = function actionItems() {
    ...
    if (flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.session.user.canManageWarnings()) {
      items.add("create_warning", m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
        className: "Button Button--primary",
        onclick: this.handleOnClickCreate.bind(this)
      }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.translator.trans("askvortsov-moderator-warnings.forum.warning_list.add_button")));
    }
  ...
  _proto.handleOnClickCreate = function handleOnClickCreate(e) {
    e.preventDefault();
    flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.modal.show(_WarningModal__WEBPACK_IMPORTED_MODULE_7__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
/* harmony import */ var flarum_utils_classList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! flarum/utils/classList */ "flarum/utils/classList");
/* harmony import */ var flarum_utils_classList__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_classList__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _WarningPost__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./WarningPost */ "./src/forum/components/WarningPost.js");
/* harmony import */ var _WarningControls__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./WarningControls */ "./src/forum/components/WarningControls.js");
...
var WarningListItem = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    var warning = this.attrs.warning;
    var addedByUser = warning.addedByUser();
    var controls = _WarningControls__WEBPACK_IMPORTED_MODULE_9__["default"].controls(warning, this).toArray();
    return m("div", this.elementAttrs(), controls.length ? flarum_components_Dropdown__WEBPACK_IMPORTED_MODULE_2___default.a.component({
    ...
    }, flarum_helpers_avatar__WEBPACK_IMPORTED_MODULE_4___default()(addedByUser), " ", flarum_helpers_username__WEBPACK_IMPORTED_MODULE_5___default()(addedByUser))), m("span", {
      ...
      time: flarum_helpers_humanTime__WEBPACK_IMPORTED_MODULE_6___default()(warning.createdAt()),
    ...
    }, app.translator.trans("askvortsov-moderator-warnings.forum.warning_list_item.linked_post")), _WarningPost__WEBPACK_IMPORTED_MODULE_8__["default"].component({
      post: warning.post()
    })) : "", m("li", {
      className: "item-excerpt"
    }, m("h3", {
      className: "WarningListItem-subtitle"
    }, app.translator.trans("askvortsov-moderator-warnings.forum.warning_list_item.public_comment")), m("p", {
      "class": "WarningListItem-comment"
    }, m.trust(warning.public_comment()))), app.session.user.canManageWarnings() && warning.private_comment() ? m("li", {
      className: "item-excerpt"
    }, m("h3", {
      className: "WarningListItem-subtitle"
    }, app.translator.trans("askvortsov-moderator-warnings.forum.warning_list_item.private_comment")), m("p", {
      "class": "WarningListItem-comment"
  ...
  _proto.elementAttrs = function elementAttrs() {
    var warning = this.attrs.warning;
    var attrs = {};
    attrs.className = (attrs.className || "") + " " + flarum_utils_classList__WEBPACK_IMPORTED_MODULE_7___default()({
...
var WarningModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.publicComment = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()("");
    this.privateComment = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()("");
    this.strikes = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(0);
  };
  ...
  _proto.title = function title() {
    return app.translator.trans("askvortsov-moderator-warnings.forum.warning_modal.heading", {
      username: flarum_helpers_username__WEBPACK_IMPORTED_MODULE_3___default()(this.attrs.user)
    });
  };
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    app.store.createRecord("warnings").save(newWarning).then(this.hide.bind(this)).then(this.successAlert = app.alerts.show({
      type: "success"
    }, app.translator.trans("askvortsov-moderator-warnings.forum.warning_modal.confirmation_message"))).then(this.attrs.callback)["catch"](function () {});
  };
...
var WarningNotification = /*#__PURE__*/function (_Notification) {
  ...
  _proto.content = function content() {
    var warning = this.attrs.notification.subject();

    if (warning.strikes()) {
      return app.translator.trans("askvortsov-moderator-warnings.forum.notifications.warning_text", {
        mod_username: flarum_helpers_username__WEBPACK_IMPORTED_MODULE_2___default()(this.attrs.notification.fromUser()),
        strikes: warning.strikes() || 0
      });
    } else {
...
/* harmony import */ var _WarningListItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./WarningListItem */ "./src/forum/components/WarningListItem.js");
...
var WarningPreview = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, m(_WarningListItem__WEBPACK_IMPORTED_MODULE_3__["default"], {
